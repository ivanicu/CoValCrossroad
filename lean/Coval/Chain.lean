...
/-- Experiment `r133-the-veto` (D8).
    ...
    not a target any external rule could reach. -/
...
/-- 1 independent measurement(s) establish `the_ratings_capture_a_shared_standard_not_personal_values`. -/
axiom the_ratings_capture_a_shared_standard_not_personal_values_established : Evidence the_ratings_capture_a_shared_standard_not_personal_values → the_ratings_capture_a_shared_standard_not_personal_values
theorem the_ratings_capture_a_shared_standard_not_personal_values_holds : the_ratings_capture_a_shared_standard_not_personal_values := the_ratings_capture_a_shared_standard_not_personal_values_established ev_the_ratings_capture_a_shared_standard_not_personal_values_by_r134_do_ratings_individuate
...
axiom the_ratings_capture_a_shared_standard_not_personal_values_supports_A2_participant_criteria_and_ratings_represent_their_values : the_ratings_capture_a_shared_standard_not_personal_values → A2_participant_criteria_and_ratings_represent_their_values
theorem A2_participant_criteria_and_ratings_represent_their_values_is_supported_via_the_ratings_capture_a_shared_standard_not_personal_values : A2_participant_criteria_and_ratings_represent_their_values := the_ratings_capture_a_shared_standard_not_personal_values_supports_A2_participant_criteria_and_ratings_represent_their_values the_ratings_capture_a_shared_standard_not_personal_values_holds
