...
DISCOVERY = _ROOT / "rounds/r41_criterion_support/results/r41_satisfaction_qwen2b.npz"
...
HELDOUT = _ROOT / "rounds/r41_criterion_support/results/r46_satisfaction.npz"
...
def main() -> None:
    ...
    verdict = (
        ...
        f"RETRACTIONS prose -- and in NO ARTIFACT: `rounds/r56_semantic_selectivity/` has contained "
