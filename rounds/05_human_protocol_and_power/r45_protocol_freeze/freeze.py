...
def main() -> None:
    ...
    ap.add_argument("--r38", type=Path,
                    default=_ROOT / "rounds/05_human_protocol_and_power/r38_human_sampling_power/results/"
                                    "r38_human_sampling_power.json")
    ap.add_argument("--gen", type=Path,
                    default=_ROOT / "rounds/02_attribution_under_attack/r12_response_set/results/"
