...
def main() -> None:
    ...
    ap.add_argument("--r12", type=Path,
                    default=_ROOT / "rounds/02_attribution_under_attack/r12_response_set/results/a12_response_set.json")
    ap.add_argument("--gen", type=Path,
                    default=_ROOT / "rounds/02_attribution_under_attack/r12_response_set/results/a12_fresh_generations.json")
    ap.add_argument("--feat", type=Path,
                    default=_ROOT / "rounds/05_human_protocol_and_power/r39_feature_cache/results/r39_feature_cache.npz")
    ...
    rep = _ROOT / "rounds/06_the_judges_mechanism/r46_spread_replication/results/r46_spread_replication.json"
    if rep.exists():
