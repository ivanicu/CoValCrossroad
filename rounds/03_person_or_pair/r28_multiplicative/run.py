...
def _cell():
    spec = importlib.util.spec_from_file_location(
        "cell", _ROOT / "rounds/03_person_or_pair/r25_actor_dyad_sweep/cell.py")
...
def main() -> None:
    ...
    # `python rounds/03_person_or_pair/r28_multiplicative/run.py` did not refresh the claim it
