...
def main() -> None:
    ...
    p.add_argument("--source", type=Path,
                   default=_ROOT / "rounds/01_object_and_rebuild/r02_label_and_regime/results/a02_position_bias.json")
    ...
    if not a.source.exists():
        raise SystemExit(f"missing {a.source} -- run rounds/01_object_and_rebuild/r02_label_and_regime/run.py first")
