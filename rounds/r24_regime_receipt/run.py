...
def main() -> None:
    ...
    p.add_argument("--source", type=Path,
                   default=_ROOT / "rounds/r02_label_and_regime/results/a02_position_bias.json")
    ...
    if not a.source.exists():
        raise SystemExit(f"missing {a.source} -- run rounds/r02_label_and_regime/run.py first")
