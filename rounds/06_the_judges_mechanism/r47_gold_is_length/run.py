...
def main() -> None:
    ...
    receipts = {
        "r12 (discovery)": _ROOT / "rounds/05_human_protocol_and_power/r41_criterion_support/results/"
                                   "r41_satisfaction_qwen2b_receipt.json",
        "r46 (held out)": _ROOT / "rounds/05_human_protocol_and_power/r41_criterion_support/results/"
                                  "r46_satisfaction_receipt.json"}
    samples = [load_sample(
        "r12 (discovery)",
        _ROOT / "rounds/05_human_protocol_and_power/r41_criterion_support/results/r41_satisfaction_qwen2b.npz",
        _ROOT / "rounds/02_attribution_under_attack/r12_response_set/results/a12_fresh_generations.json",
    ...
    r46 = _ROOT / "rounds/05_human_protocol_and_power/r41_criterion_support/results/r46_satisfaction.npz"
    if r46.exists():
        ...
        samples.append(load_sample(
            "r46 (held out)", r46,
            _ROOT / "rounds/06_the_judges_mechanism/r46_spread_replication/results/r46_fresh_generations.json",
            ("mean_orig_real", "mean_orig_shuf", "mean_fresh_real", "mean_fresh_shuf")))
    else:
