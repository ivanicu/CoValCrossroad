...
Target
observed?  YES. `rounds/05_human_protocol_and_power/r39_feature_cache/results/r39_feature_cache.npz` is 57 MB,
...
CACHE = _ROOT / "rounds/05_human_protocol_and_power/r39_feature_cache/results/r39_feature_cache.npz"
R40 = _ROOT / "rounds/05_human_protocol_and_power/r40_ood_map/results/r40_ood_map.json"
PCA_DIMS = 48
...
def main() -> None:
    ...
    verdict = (
        ...
        f"`rounds/05_human_protocol_and_power/r39_feature_cache/results/r39_feature_cache.npz`, 57 MB, TRACKED IN GIT, holding "
