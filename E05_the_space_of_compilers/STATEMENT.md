...
| **④** | behavioural | **all 7** arms on the second release | ⚠ **UNVERIFIED, not established** — ② excludes **the same 7** *(R434)*, and at home ④ excludes **0 of 56** *(R436, `W-REDUNDANT-AT-J`)*. In both populations a marginal is 0, so the ②pass∧④fail cell is empty **by construction**; a non-degenerate pairing would expect **6.62** *(R517)*. ④ is **not** a reparameterisation of ② *(R439)*, which is a different property |
