...
A = ROOT / "E05_the_space_of_compilers/A24_what_the_definition_costs"
# ⚠ THIS TABLE IS AN INSTRUMENT AND HAS HAD TWO BLIND SPOTS. (1) The uppercase key `UNRESOLVED`
# was missing while the lowercase one was present, producing a FALSE disagreement on R307/gen
