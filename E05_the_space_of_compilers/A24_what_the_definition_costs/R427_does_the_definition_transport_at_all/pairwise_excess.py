...
def main() -> int:
    ...
    # ⚠ THE THIRD DRAW ANSWERS A NARROW QUESTION AND THE ROUND SAYS WHICH. R427/spread_resolution
    #    showed the two-point gap is 3.96x its own resolution, so `do random draws behave
