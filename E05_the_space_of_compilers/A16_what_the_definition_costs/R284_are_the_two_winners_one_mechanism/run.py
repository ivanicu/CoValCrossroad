...
WHY, AND WHY IT MATTERS MORE THAN THE TIE ITSELF. R282: at exactly matched size k=4, only TWO of
seven ways of reading the prompt beat `generic` — `coval_core` (+0.0151) and `topw_k4` (+0.0128).
R280: those two are indistinguishable from each other (+0.0023 against an MDE of 0.0085).
