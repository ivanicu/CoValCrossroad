...
TARGETS = [
    ("R221", "A02_does_decision_fitting_select_norms_or_the_proxy/R221_contamination", "salted"),
    ("R238", "A07_the_candidate_set_wall_was_wrong/R238_difficulty_matched", "salted"),
    ("R241", "A07_the_candidate_set_wall_was_wrong/R241_find_a_valid_stratifier", "salted"),
    ("R244", "A12_missing_weight_semantics/R244_not_rated_or_rated_zero", "salted"),
    ("R245", "A12_missing_weight_semantics/R245_does_it_move_the_formulation", "salted"),
    ("R231", "A04_which_definitions_of_core_are_identifiable/R231_the_official_cores_class",
     "positive"),
    ("R230", "A04_which_definitions_of_core_are_identifiable/R230_the_class_not_the_member",
     "negative"),
    ("R228", "A04_which_definitions_of_core_are_identifiable/R228_the_largest_core_this_release_can_carry",
     "negative"),
]
...
def main() -> int:
    ...
    a = run_one(("R230", "A04_which_definitions_of_core_are_identifiable/R230_the_class_not_the_member",
                 "5"))[2]
    b = run_one(("R230", "A04_which_definitions_of_core_are_identifiable/R230_the_class_not_the_member",
                 "5"))[2]
