...
def main() -> None:
    ...
    ap.add_argument("--feat", type=Path,
                    default=_ROOT / "05_human_protocol_and_power/r39_feature_cache/results/r39_feature_cache.npz")
    ...
    rep = _ROOT / "06_the_judges_mechanism/r46_spread_replication/results/r46_spread_replication.json"
    if rep.exists():
