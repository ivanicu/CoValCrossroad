...
SOURCES = [
    ("r34", "04_what_core_is/r34_global_rater_crossfit/results/r34_global_rater_crossfit.json",
     ["estimands"], "cross-fitted concordance vs individual rater rankings, original menu"),
    ("r35", "04_what_core_is/r35_polarity_abstention/results/r35_polarity_abstention.json",
     ["regimes", "*", "comparisons"], "post-hoc abstention only; not elicitation-time neutrality"),
    ("r36", "04_what_core_is/r36_channel_shapley/results/r36_channel_shapley.json",
     ["shapley"], "Shapley over 16 coalitions; predictive, not causal"),
    ("r37", "04_what_core_is/r37_leakage_topology/results/r37_leakage_topology.json",
