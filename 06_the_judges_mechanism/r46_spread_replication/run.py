...
def main() -> None:
    ...
    ap.add_argument("--gold", type=Path,
                    default=_ROOT / "01_object_and_rebuild/r08_gold_preference/results/a08_gold_08b.npz")
    ...
    r12_pids = set()
    gp = _ROOT / "02_attribution_under_attack/r12_response_set/results/a12_fresh_generations.json"
    if gp.exists():
