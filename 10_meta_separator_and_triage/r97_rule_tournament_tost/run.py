...
sys.path.insert(0, str(_ROOT / "01_object_and_rebuild/r06_rule_tournament"))

from covalx import LABELS, load_join, parse_ranking  # noqa: E402
from run import build_cores  # noqa: E402

A06 = _ROOT / "01_object_and_rebuild/r06_rule_tournament/results/a06_rule_tournament.json"
