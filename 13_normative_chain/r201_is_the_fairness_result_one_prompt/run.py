...
sys.path.insert(0, str(ROOT / "13_normative_chain" / "r146_does_compilation_add"))
...
def main() -> int:
    ...
    spec = importlib.util.spec_from_file_location(
        "r146", ROOT / "13_normative_chain/r146_does_compilation_add/run.py")
    ...
    sat_full = r146.load_sat(ROOT / "01_object_and_rebuild/r04_rebuild_satisfaction/results/"
                             "a04_full.npz")
    sat_core = r146.load_sat(ROOT / "01_object_and_rebuild/r04_rebuild_satisfaction/results/"
                             "a04_core.npz")
    if demo is None:
        demo = {}
