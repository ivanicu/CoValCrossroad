...
sys.path.insert(0, str(ROOT / "13_normative_chain" / "r164_instrument"))
OUT = HERE / "results"
...
def main() -> int:
    ...
    R = ROOT / "13_normative_chain" / "r164_instrument" / "results"
    ...
    r130 = []
    for f in sorted(glob.glob(str(ROOT / "12_compilation_redistribution" / "r130_judge_gauge"
                                  / "results" / "*.json"))):
