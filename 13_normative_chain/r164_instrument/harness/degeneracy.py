...
for name, path in [("full", f"{ROOT}/01_object_and_rebuild/r04_rebuild_satisfaction/results/a04_full.npz"),
                    ("core", f"{ROOT}/01_object_and_rebuild/r04_rebuild_satisfaction/results/a04_core.npz")]:
