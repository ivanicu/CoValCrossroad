...
R12 = ROOT / "E04_no_fraction_only_an_equivalence_class/A04_is_the_detection_design_well_defined/R212_rebuilt_on_decisions/results"
...
def main() -> int:
  ...
  [{lo_w:+.3f}, {hi_w:+.3f}]. {'CONFIRMED -- the cancellation r214 proposed has the sign it needs.' if lo_w > 0 else 'REFUTED -- the flatness of the flip rate across margins needs a different explanation, and r214 should not be read as having one.'}""")
    ...
    print("=" * 100)
    sa = json.loads((ROOT / "E04_no_fraction_only_an_equivalence_class/A04_is_the_detection_design_well_defined/R212_rebuilt_on_decisions/results"
