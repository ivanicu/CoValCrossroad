# No fraction only an equivalence class

**Epoch E04.** self-dated in NORTH_STAR.md: "asking for that number is the error this project made for sixty rounds". Normative information becomes [N]_Q. No finite weight encodes a veto; 82.3% of criteria carry no condition, exception, priority, hedge or prohibition.
