...
def main() -> int:
    ...
    # ---------------------------------------------------------------- rebuild r188's null
    d = np.load(ROOT / "E01_the_rubric_was_the_object/A01_can_this_release_be_analysed_at_all/R04_rebuild_satisfaction/results/a04_full.npz",
                allow_pickle=True)
    sat = {}
    ...
    print("=" * 92)
    reg = json.loads((ROOT / "E04_no_fraction_only_an_equivalence_class/A14_do_our_own_claims_survive_an_adversary/R203_what_can_even_be_attacked/results/"
