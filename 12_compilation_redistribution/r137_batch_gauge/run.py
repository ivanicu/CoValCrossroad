...
def main() -> int:
    ...
    src = (_ROOT / "01_object_and_rebuild/r04_rebuild_satisfaction/run.py").read_text()
    G = {"np": np}
    ...
    stored = {}
    for nm in ("full", "core"):
        z = np.load(_ROOT / f"01_object_and_rebuild/r04_rebuild_satisfaction/results/a04_{nm}.npz",
                    allow_pickle=True)
