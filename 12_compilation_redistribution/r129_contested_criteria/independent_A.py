...
THE MATCHING PROBLEM, and how this design routes around it:
  ...
  tensors (01_object_and_rebuild/r04_rebuild_satisfaction/results/a04_*.npz):
...
d_full = np.load(ROOT / "01_object_and_rebuild/r04_rebuild_satisfaction/results/a04_full.npz",
                  allow_pickle=True)
d_core = np.load(ROOT / "01_object_and_rebuild/r04_rebuild_satisfaction/results/a04_core.npz",
                  allow_pickle=True)
...
report = dict(
    ...
    design_summary=(
        ...
        "(both from 01_object_and_rebuild/r04_rebuild_satisfaction precomputed tensors, no "
