...
INSTRUMENT  : local Qwen3.5-2B-Base judge, PRECOMPUTED satisfaction
              tensors 01_object_and_rebuild/r04_rebuild_satisfaction/
...
REGIME      : matched-cardinality (n=4 criteria/prompt) subsets of
              ...
              01_object_and_rebuild/r04_rebuild_satisfaction/run.py's own
...
NPZ_FULL = _ROOT / "01_object_and_rebuild" / "r04_rebuild_satisfaction" / "results" / "a04_full.npz"
NPZ_CORE = _ROOT / "01_object_and_rebuild" / "r04_rebuild_satisfaction" / "results" / "a04_core.npz"
