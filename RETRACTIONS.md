...
> it. [r35](rounds/r35_polarity_abstention) carries a `scale_note` recording exactly this: *"the value
...
**It had.** [r35](rounds/r35_polarity_abstention) stores a `scale_note` saying it verbatim: *"the value
