...
def main() -> None:
    ...
    p.add_argument("--per-prompt", type=Path,
                   default=_ROOT / "02_attribution_under_attack/r22_cross_family/results/r22_cross_family_per_prompt.npz")
    p.add_argument("--summary", type=Path,
                   default=_ROOT / "02_attribution_under_attack/r22_cross_family/results/r22_cross_family.json")
    p.add_argument("--r19", type=Path,
                   default=_ROOT / "02_attribution_under_attack/r19_floor_choice/results/r19_floor_choice.json")
