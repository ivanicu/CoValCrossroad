...
def main() -> None:
    ...
    ap.add_argument("--feat", type=Path,
                    default=_ROOT / "E02_the_plural_public_dissolved/A06_does_the_protocol_have_the_power_it_needs/R39_feature_cache/results/r39_feature_cache.npz")
    ...
    rep = _ROOT / "E03_the_instrument_was_the_object/A07_can_a_local_judge_be_an_instrument/R46_spread_replication/results/r46_spread_replication.json"
    if rep.exists():
