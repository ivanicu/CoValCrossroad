...
def main() -> None:
    ...
    p.add_argument("--per-prompt", type=Path,
                   default=_ROOT / "E01_the_rubric_was_the_object/A03_is_the_attribution_real_and_against_what_floor/R22_cross_family/results/r22_cross_family_per_prompt.npz")
    p.add_argument("--summary", type=Path,
                   default=_ROOT / "E01_the_rubric_was_the_object/A03_is_the_attribution_real_and_against_what_floor/R22_cross_family/results/r22_cross_family.json")
    p.add_argument("--r19", type=Path,
                   default=_ROOT / "E01_the_rubric_was_the_object/A03_is_the_attribution_real_and_against_what_floor/R19_floor_choice/results/r19_floor_choice.json")
