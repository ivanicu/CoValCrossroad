...
---------------------------
`06_the_judges_mechanism/r54_overlap_transfer/run.py` defaults `--gen` to `a12_response_set.json`,
...
GEN = _ROOT / "02_attribution_under_attack/r12_response_set/results/a12_fresh_generations.json"
