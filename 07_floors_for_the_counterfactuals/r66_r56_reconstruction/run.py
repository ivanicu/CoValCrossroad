...
DISCOVERY = _ROOT / "05_human_protocol_and_power/r41_criterion_support/results/r41_satisfaction_qwen2b.npz"
...
HELDOUT = _ROOT / "05_human_protocol_and_power/r41_criterion_support/results/r46_satisfaction.npz"
...
def main() -> None:
    ...
    verdict = (
        ...
        f"RETRACTIONS prose -- and in NO ARTIFACT: `06_the_judges_mechanism/r56_semantic_selectivity/` has contained "
