...
def main() -> None:
    ...
    receipts = {
        "r12 (discovery)": _ROOT / "E02_the_plural_public_dissolved/A03_does_the_protocol_have_the_power_it_needs/R41_criterion_support/results/"
                                   "r41_satisfaction_qwen2b_receipt.json",
        "r46 (held out)": _ROOT / "E02_the_plural_public_dissolved/A03_does_the_protocol_have_the_power_it_needs/R41_criterion_support/results/"
                                  "r46_satisfaction_receipt.json"}
    samples = [load_sample(
        "r12 (discovery)",
        _ROOT / "E02_the_plural_public_dissolved/A03_does_the_protocol_have_the_power_it_needs/R41_criterion_support/results/r41_satisfaction_qwen2b.npz",
    ...
    r46 = _ROOT / "E02_the_plural_public_dissolved/A03_does_the_protocol_have_the_power_it_needs/R41_criterion_support/results/r46_satisfaction.npz"
    if r46.exists():
        ...
        samples.append(load_sample(
            "r46 (held out)", r46,
            _ROOT / "E03_the_instrument_was_the_object/A01_can_a_local_judge_be_an_instrument/R46_spread_replication/results/r46_fresh_generations.json",
            ("mean_orig_real", "mean_orig_shuf", "mean_fresh_real", "mean_fresh_shuf")))
    else:
