...
def main() -> None:
    ...
    ap.add_argument("--gold", type=Path,
                    default=_ROOT / "E01_the_rubric_was_the_object/A02_which_aggregation_rule/R08_gold_preference/results/a08_gold_08b.npz")
    ...
    r12_pids = set()
    gp = _ROOT / "E01_the_rubric_was_the_object/A03_is_the_attribution_real_and_against_what_floor/R12_response_set/results/a12_fresh_generations.json"
    if gp.exists():
