...
# r60's `collect` is imported BY FILE PATH, not as a module. This line used to read
# `from rounds.r60_world_vs_personal.run import collect`, which the campaign reorganisation broke and
# no gate caught -- every path check looked for the string "rounds/rNN_", and a DOTTED module path
# contains no slash. It cannot be repaired as an import either: campaigns are named 07_..., and a
# module name may not begin with a digit. So the only durable form is importlib on the path.
import importlib.util as _ilu  # noqa: E402
_r60 = _ROOT / "E03_the_instrument_was_the_object/A08_what_floor_each_counterfactual_requires/R60_world_vs_personal/run.py"
_spec = _ilu.spec_from_file_location("r60_world_vs_personal_run", _r60)
_mod = _ilu.module_from_spec(_spec)
_spec.loader.exec_module(_mod)
collect = _mod.collect

R60 = _ROOT / "E03_the_instrument_was_the_object/A08_what_floor_each_counterfactual_requires/R60_world_vs_personal/results/r60_world_vs_personal.json"
